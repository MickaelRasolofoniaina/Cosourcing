...
import { Employe, Genre, Situation, TypeContrat, Categorie, Groupe, ModeReglement, Poste, MotifSortie } from "../../../models/entite/Employe";
import { Pays } from "../../../models/entite/Pays";
...
const EmployeSchema: ObjectSchema<Employe> = object({
    ...
    paysNaissance: mixed<Pays>()
        .required("Veuillez indiquer le pays de naissance de l'employé"),
    paysNationalite: mixed<Pays>().required("Veuillez indiquez la nationnalité de l'employé"),
    ...
    poste: mixed<Poste>().required("Vueillez indiquer le poste qu'occupe l'employé"),
    ...
    motifSortie: mixed<MotifSortie>().required("veuillez indiquer le motif de sortie").default(MotifSortie.DEMISSION),
}).required();
    ...
    return (
        <BaseEcran titre="Ajouter un employé">
            ...
            <form onSubmit={onSubmit}>
                ...
                <Grid container spacing={2} >
                    ...
                    <Grid item xs={4}>
                        <TextField
                            ...
                            select
                        >
                            {Object.entries(Pays).map(([initial, option]) => (
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={4}>
                        <TextField
                            ...
                            select
                        >
                            {Object.values(Poste).map((option) => (
                                <MenuItem key={option} value={option}>
                                    {option}
                                </MenuItem>
                            ))}
                ...
                <input {...register("motifSortie")} type="hidden" value={MotifSortie.DEMISSION} />
            </form>
            <Snackbar
                open={erreur}
